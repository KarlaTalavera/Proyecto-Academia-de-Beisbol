...
const routes = [
  ...
  // ── Zona Administrativa (todos los roles excepto publico) ───
  {
    ...
    children: [
      ...
      { path: 'reportes/taquilla', name: 'ReporteTaquilla', component: () => import('@/views/reportes/ReporteTaquillaView.vue') },
      { path: 'reportes/bateadores', name: 'ReporteBateadores', component: () => import('@/views/reportes/ReporteBateadoresView.vue') },
