...
.ld-page {
  min-height: 100vh;
  background: #1B2431; /* Azul marino */
  font-family: 'Arial Black', 'Segoe UI', Arial, sans-serif;
  color: #E4E3F1; /* Lavanda */
}
...
.ld-week-nav {
  ...
  background: rgba(27, 36, 49, 0.5); /* Semi marino */
  border-top: 1px solid rgba(135, 176, 212, 0.2);
  border-bottom: 1px solid rgba(135, 176, 212, 0.2);
}

.ld-week-btn {
  padding: 0.45rem 1rem;
  background: rgba(135, 176, 212, 0.1);
  border: 1px solid rgba(135, 176, 212, 0.3);
...
.ld-day-header {
  ...
  border-bottom: 1px solid rgba(135, 176, 212, 0.1);
}
...
.ld-cal-card:hover {
  background: rgba(200, 116, 196, 0.1);
  border-color: rgba(200, 116, 196, 0.3);
